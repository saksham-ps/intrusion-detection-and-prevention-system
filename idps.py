...
def send_email_alert(subject, body, to_email):
    from_email = "sakshamlatwal2@gmail.com"
    from_password = "rdfb cmqo xdfw kfad"
...
class IDPSEventHandler(FileSystemEventHandler):
    def __init__(self, ignore_patterns=None, anomaly_detector=None, alert_email="roronoa.zoro.3638@gmail.com"):
        super().__init__()
...
def main():
    ...
    alert_email = "sakshamlatwal0@gmail.com"
